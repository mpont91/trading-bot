...
export class PrismaRiskRepository implements RiskRepository {
  ...
  private toDomain(prismaRisk: PrismaRisk): Risk {
    return {
      ...
      validStops: prismaRisk.valid_stops ? prismaRisk.valid_stops : undefined,
      riskReward: prismaRisk.risk_reward ? prismaRisk.risk_reward : undefined,
  ...
  private toPrisma(risk: RiskCreate): Prisma.RiskCreateInput {
    return {
      ...
      valid_stops: risk.validStops ? risk.validStops : undefined,
      risk_reward: risk.riskReward ? risk.validStops : undefined,
