...
import { StrategyFuturesCreate } from '../models/strategy'
...
export class FuturesStrategy implements StrategyInterface {
  constructor(
  ...
  public async createStrategy(symbol: string): Promise<StrategyFuturesCreate> {
